...
export async function getServerSideProps({ query }) {
  ...
  try {
    ...
    const bffUrl = `http://localhost:3002/api/recommendations?item_id=${encodeURIComponent(itemId)}&models=${encodeURIComponent(models.join(','))}`
    ...
    return {
      props: {
        modelResults: bffResponse.results,
        error: null,
        itemId,
        models
      }
